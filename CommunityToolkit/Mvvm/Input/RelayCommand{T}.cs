...
namespace CommunityToolkit.Mvvm.Input
{
    ...
    public sealed class RelayCommand<T> : IRelayCommand<T>
    {
        ...
        internal static void ThrowArgumentExceptionForInvalidCommandArgument(object parameter)
        {
            ...
            Exception GetException(object parameter1)
            {
                if (parameter is null)
                {
                    return new ArgumentException($"Parameter \"{nameof(parameter1)}\" (object) must not be null, as the command type requires an argument of type {typeof(T)}.", nameof(parameter1));
                }

                return new ArgumentException($"Parameter \"{nameof(parameter1)}\" (object) cannot be of type {parameter1.GetType()}, as the command type requires an argument of type {typeof(T)}.", nameof(parameter1));
            }
