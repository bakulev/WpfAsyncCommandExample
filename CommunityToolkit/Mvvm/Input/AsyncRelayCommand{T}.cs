    ...
    public sealed class AsyncRelayCommand<T> : IAsyncRelayCommand<T>, ICancellationAwareCommand
    {
        ...
        public Task ExecutionTask
        {
            ...
            private set
            {
                ...
                async void MonitorTask(AsyncRelayCommand<T> @this, Task task)
                {
        ...
        public bool CanExecute(T parameter)
        {
            ...
            return canExecute && ((this.options & AsyncRelayCommandOptions.AllowConcurrentExecutions) != 0 || ExecutionTask.IsCompleted != false);
        }
