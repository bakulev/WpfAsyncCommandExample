    ...
    public sealed class AsyncRelayCommand : IAsyncRelayCommand, ICancellationAwareCommand
    {
        ...
        public Task ExecutionTask
        {
            ...
            private set
            {
                ...
                async void MonitorTask(AsyncRelayCommand @this, Task task)
                {
        ...
        /// <inheritdoc/>
        public bool CanBeCanceled => IsRunning && this.cancellationTokenSource.IsCancellationRequested == false;

        /// <inheritdoc/>
        public bool IsCancellationRequested => this.cancellationTokenSource.IsCancellationRequested == true;

        /// <inheritdoc/>
        public bool IsRunning => (ExecutionTask != null) && ExecutionTask.IsCompleted == false;
        ...
        public bool CanExecute(object parameter)
        {
            ...
            return canExecute && ((this.options & AsyncRelayCommandOptions.AllowConcurrentExecutions) != 0 || (ExecutionTask == null || ExecutionTask.IsCompleted != false));
        }
