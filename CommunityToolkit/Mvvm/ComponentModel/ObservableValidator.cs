...
namespace CommunityToolkit.Mvvm.ComponentModel
{
    ...
    public abstract class ObservableValidator : ObservableObject, INotifyDataErrorInfo
    {
        ...
        /// </summary>
        private static readonly ConditionalWeakTable<Type, Action<object>> EntityValidatorMap = new ConditionalWeakTable<Type, Action<object>>();
        ...
        /// </remarks>
        private static readonly ConditionalWeakTable<Type, Dictionary<string, string>> DisplayNamesMap = new ConditionalWeakTable<Type, Dictionary<string, string>>();
        ...
        public IEnumerable<ValidationResult> GetErrors(string propertyName = null)
        {
            ...
            if (string.IsNullOrEmpty(propertyName))
            {
                ...
                {
                    return this.errors.Values.SelectMany(errors1 => errors1);
                }
        ...
        protected void ValidateAllProperties()
        {
            ...
            //[RequiresUnreferencedCode("The type of the current instance cannot be statically discovered.")]
            Action<object> GetValidationAction(Type type)
            {
            ...
            Action<object> GetValidationActionFallback(Type type)
            {
        ...
        {
            Dictionary<string, string> GetDisplayNames(Type type)
            {
                Dictionary<string, string> displayNames = new Dictionary<string, string>();

                foreach (PropertyInfo property in type.GetProperties(BindingFlags.Instance | BindingFlags.Public))
                {
                    var attribute = property.GetCustomAttribute<DisplayAttribute>() as DisplayAttribute;
                    if (attribute != null)
                    {
                        var displayName1 = attribute.GetName() as string;
                        if (displayName1 != null)
                        {
                            displayNames.Add(property.Name, displayName1);
                        }
                    }
                }
            ...
            _ = DisplayNamesMap.GetValue(GetType(), t => GetDisplayNames(t)).TryGetValue(propertyName, out string displayName);
